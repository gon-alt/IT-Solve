  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setErrorMsg(err.error || "Error al enviar. Intentá de nuevo.");
      }
    } catch {
      setErrorMsg("Error de conexión. Revisá tu internet.");
    } finally {
      setEnviando(false);
    }
  }
      ...
      <section className="py-12 px-6 max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
        <div className="p-8 bg-slate-900 border border-slate-800 rounded-2xl hover:border-blue-500/50 transition-colors">
          <div className="w-12 h-12 bg-blue-500/20 rounded-lg flex items-center justify-center mb-6">
            <svg className="text-blue-500 w-6 h-6" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M8.111 16.404a5.5 5.5 0 117.778 0M12 20h.01m-7.08-7.071c3.904-3.905 10.257-3.905 14.162 0M1.394 9.393c5.857-5.857 15.355-5.857 21.213 0" /></svg>
          </div>
        ...
        <div className="p-8 bg-slate-900 border border-slate-800 rounded-2xl hover:border-emerald-500/50 transition-colors">
          <div className="w-12 h-12 bg-emerald-500/20 rounded-lg flex items-center justify-center mb-6">
            <svg className="text-emerald-500 w-6 h-6" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" /></svg>
          </div>
        ...
        <div className="p-8 bg-slate-900 border border-slate-800 rounded-2xl hover:border-purple-500/50 transition-colors">
          <div className="w-12 h-12 bg-purple-500/20 rounded-lg flex items-center justify-center mb-6">
            <svg className="text-purple-500 w-6 h-6" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
          </div>
        ...
        <div className="max-w-3xl mx-auto px-6">
          ...
          {enviado && (
            <div className="mb-8 p-6 bg-emerald-500/10 border border-emerald-500/30 rounded-2xl text-center">
              <p className="text-emerald-400 text-lg font-semibold">✅ ¡Relevamiento enviado con éxito!</p>
              <p className="text-slate-400 mt-2">Ya recibí tus datos. Te contacto a la brevedad.</p>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-10">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center space-x-6">
                ...
                <label className="flex items-center"><input type="radio" name="cables" value="Sí" className="mr-2" /> Sí</label>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <label className="flex items-center"><input type="radio" name="backup" value="Sí, en la nube (Drive/OneDrive)" className="mr-2" /> Sí, en la nube (Drive/OneDrive)</label>
                  <label className="flex items-center"><input type="radio" name="backup" value="Sí, en disco externo/pendrive" className="mr-2" /> Sí, en disco externo/pendrive</label>
                  <label className="flex items-center"><input type="radio" name="backup" value="No tengo / No estoy seguro" className="mr-2" /> No tengo / No estoy seguro</label>
                </div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                ...
                <div>
                  ...
                  <select name="antivirus" className="w-full bg-slate-800 border border-slate-700 rounded-lg p-3 outline-none">
                    ...
                    <option value="No / Solo Windows Defender">No / Solo Windows Defender</option>
                  </select>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-4">
                  <label className="flex items-center"><input type="radio" name="wa_vol" value="Menos de 20" className="mr-2" /> Menos de 20</label>
                  <label className="flex items-center"><input type="radio" name="wa_vol" value="20 a 100" className="mr-2" /> 20 a 100</label>
                  <label className="flex items-center"><input type="radio" name="wa_vol" value="+de 100" className="mr-2" /> + de 100</label>
                </div>
              </div>
              <div className="flex items-center space-x-6">
                <span className="text-sm text-slate-300">¿Responden fuera de hora?</span>
                <label className="flex items-center"><input type="radio" name="wa_fuera" value="Sí" className="mr-2" /> Sí</label>
                <label className="flex items-center"><input type="radio" name="wa_fuera" value="No" className="mr-2" /> No</label>
                <label className="flex items-center"><input type="radio" name="wa_fuera" value="A veces" className="mr-2" /> A veces</label>
              </div>
            </div>
            ...
            <button
              ...
              className={`w-full py-4 rounded-xl font-bold text-white transition-all ${
                enviando || enviado ? "bg-slate-700 cursor-not-allowed" : "bg-blue-600 hover:bg-blue-500 shadow-xl shadow-blue-500/20"
              }`}
            >
              {enviando ? "Enviando..." : enviado ? "✅ ¡Enviado!" : "Enviar Relevamiento Técnico"}
            </button>
          </form>
        </div>
      </section>
